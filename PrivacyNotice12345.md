...
NOTE: Text shown in **_bold_** is autogenerated based on the [CSV file](https://github.com/andjnewman/PrivacyNoticeExperiment/blob/master/_data/goatlicences.csv) and hard coded logic.
